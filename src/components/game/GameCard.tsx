...
export function GameCard({ game }: GameCardProps) {
  ...
  return (
    <Link href={`/play/${game.id}`} passHref>
      <div
        className="cursor-pointer game-card w-full h-48 bg-cover bg-center rounded-lg text-white font-bold text-2xl relative transition-transform duration-300 hover:scale-105"
