...
export default function RecentPlays() {
  ...
  return (
    <div className="w-full relative flex flex-col gap-2.5 bg-none">
      {selectedGame && (
        <ShareModal
          event={selectedGame}
      ...
      {events.length > 0
        ? events.map((tx, index) => (
            <button
              ...
              className="flex items-center gap-2 p-2 rounded-lg bg-[#171919] hover:bg-[#131724] justify-between h-9" // Arka plan rengi değiştirildi
            >
